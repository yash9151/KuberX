<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Skills_Profile.aspx.cs" Inherits="LoginSignup.Pages.Skills_Profile" %>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <ul>
                  ...
                  <ul>
                           <asp:Button class="getstarted scrollto" runat="server" Text="Logout" OnClick="btn_Logout"  />
                      <!--<a class="getstarted scrollto" href="index.html">index.html</a>-->
                 </ul>
                ...
                <%--  <div class="row">
                  ...
                  <div class="row">
                      <%--<div class="col-sm-12">--%><%--<a class="btn btn-info " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills">Edit</a>--%><%--<asp:Button ID="Button1"  runat="server" Text="Upload Resume" />--%>
                        <div class="col-sm-3">
                              <h6 class="mb-0">Upload Resume</h6>
                         </div>
